...
{
    [CreateAssetMenu(fileName = "Explosive missile set config",
                     menuName = "Space ace/Configs/Shooting/Ammo/Explosive missile set config")]
    public sealed class ExplosiveMissileSetConfig : MissileSetConfig
    {
        public override AmmoType AmmoType => AmmoType.ExplosiveMissiles;
