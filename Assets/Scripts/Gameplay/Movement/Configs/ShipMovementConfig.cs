...
namespace SpaceAce.Gameplay.Movement
{
    ...
    public sealed class ShipMovementConfig : MovementConfig
    {
        ...
        public float RandomHorizontalSpeedDuration => Random.Range(_horizontalSpeedDuration.x, _horizontalSpeedDuration.y);
        ...
        public float RandomHorizontalSpeedTransitionDuration => Random.Range(_horizontalSpeedTransitionDuration.x, _horizontalSpeedTransitionDuration.y);
        ...
        public float RandomVerticalSpeedDauration => Random.Range(_verticalsSpeedDuration.x, _verticalsSpeedDuration.y);
        ...
        public float RandomVerticalSpeedTransitionDuration => Random.Range(_verticalSpeedTransitionDuration.x, _verticalSpeedTransitionDuration.y);
        ...
        public float RandomPlayerAimSpeed => Random.Range(_playerAimSpeed.x, _playerAimSpeed.y);
    }
}